...
object TextDrawMessageInputDialog {
    ...
    fun createDialog(context: Context) : AlertDialog.Builder{
        ...
        alertDialog.setTitle(context.getString(R.string.txt_text_shape_dialog_title))
        alertDialog.setMessage(context.getString(R.string.txt_text_shape_dialog_msg))
